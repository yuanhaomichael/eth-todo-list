...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (options.validate) {
        ...
        if (!valid) {
            const output = (0, better_ajv_errors_1.default)(abiSchema, abi, validate.errors, {
                format: "cli",
            });
            console.log(output);
            process.exit(1);
    ...
    process.stdout.write((0, src_1.generateSolidity)(Object.assign(Object.assign({}, options), { abi })));
});
main();
