...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.prettifyOutput = exports.solidityVersion = exports.license = exports.name = void 0;
...
const Codec = __importStar(__webpack_require__(485101));
const package_json_1 = __webpack_require__(730607);
const visitor_1 = __webpack_require__(980817);
...
const generateSolidity = ({ abi, name = defaults.name, solidityVersion = defaults.solidityVersion, license = defaults.license, prettifyOutput = prettier && defaults.prettifyOutput, }) => {
...
class SolidityGenerator {
    constructor({ name, license, solidityVersion, versionFeatures, abiFeatures, declarations, }) {
        this.name = name;
...
;
//# sourceMappingURL=589.bundled.js.map